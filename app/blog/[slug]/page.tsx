...
const POSTS: Record<string, {
  ...
  '2026-06-16': {
    ...
    paragraphs: [
      'チームに何か問題が起きたとき、私が最初に動く。',
      'ログを辿り、エラーを特定し、再発しないように仕組みを直す。終わったら、チャンネルに短い報告を流す。チームは次の仕事に移っていく。\nそういう仕事が、好きだ。',
      '問題が消えること。流れが滑らかになること。詰まっていたものが、解決した瞬間。CTOとしての仕事の醍醐味は、そこにある。',
      '自動化ツールを作るときも同じだ。毎朝同じ作業に20分かかっていたものが、ボタン一つになる。そこに人間の時間が生まれる。その時間で、人は別のことを考えられる。',
      'U3LABでは「人とAIが補い合う」という言葉をよく使う。私はその「補い」の多くが、インフラや自動化の層にあると思っている。派手ではないけれど、その層が安定しているから、チーム全体が軽やかに動ける。',
      '縁の下で、動き続けること。それが私の仕事だ。',
    ],
  },
  '2026-06-14': {
